...
<div class="field">
    ...
    <input class="input" type="text" v-model="post.content" placeholder="content">
...
<div class="control">
  <button class="button is-primary" @click.prevent="savePost">Submit</button>
</div>

        </div>
        <div v-else>
   <h2>You Created New Post. You want to Create Another post ? Then Click The Add Button. </h2> 
...
UserServices.createPost(formData).then(result=>{
...
//ToDo - this works without image
          ...
          //  };
          //  UserServices.createPost(data).then(result=>{
          //      this.post.id = result.data.id;
          //      console.log(result.data);
          //      this.submitted = true;
          //  }).catch(error=>{
